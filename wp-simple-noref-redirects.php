                ...
                <form method="post" id="simple_noref_redirects_form" action="options-general.php?page=noref_options&savedata=true">
                    ...
                    <table class="widefat">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width:35%;"><input type="text" name="noref_redirects[request][]" value="" style="width:99%;" /></td>
                                <td style="width:2%;">&raquo;</td>
                                <td style="width:60%;"><input type="text" name="noref_redirects[destination][]" value="" style="width:99%;" /></td>
                ...
                foreach ($redirects as $storedrequest => $destination) {
                    ...
                    if ($do_redirect !== '' && trim($do_redirect, '/') !== trim($userrequest, '/')) {
                        ...
                        if ($do_header_refresh == true) {
                            header('Refresh:0;URL=' . $do_redirect);
                        }
                        ?>
                        <!doctype html>
                        <html lang="ja">
                            <head>
                                ...
                                <script>
                                    ...
                                    if (check_ie()) {
                                        location.href = "<?php echo $do_redirect; ?>";
                                    }
                                </script>
                                <link rel="canonical" href="<?php echo $do_redirect; ?>" />
                                <meta http-equiv="refresh" content="0; URL=<?php echo $do_redirect; ?>" />
                            </head>
                            <body>
                                <h1>画面切り替え中・・・</h1>
